...
void insert_end() {
    ...
    if (Start == NULL) {
        ...
        struct Node* last_node = access_end();
...
void delete_end() {
    ...
    if (Start->next == NULL) {
        ...
        struct Node* second_last = access_second_last();
...
void concatenate(struct Node* Start1, struct Node* Start2) {
    ...
    if (end1 != NULL) {
        ...
        printf("Cannot concatenate. Start1 is empty.\n");
    }
}
